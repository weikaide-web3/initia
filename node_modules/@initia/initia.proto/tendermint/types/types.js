...
exports.Vote = {
    ...
    fromPartial(object) {
        ...
        message.extensionSignature = (_h = object.extensionSignature) !== null && _h !== void 0 ? _h : new Uint8Array(0);
        return message;
    },
};
...
exports.ExtendedCommit = {
    ...
    fromPartial(object) {
        ...
        message.extendedSignatures =
            ((_b = object.extendedSignatures) === null || _b === void 0 ? void 0 : _b.map((e) => exports.ExtendedCommitSig.fromPartial(e))) || [];
        return message;
    },
};
