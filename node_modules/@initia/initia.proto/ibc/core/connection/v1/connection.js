...
exports.ClientPaths = {
    ...
    fromJSON(object) {
        return {
            paths: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.paths)
                ? object.paths.map((e) => globalThis.String(e))
                : [],
        };
    },
    toJSON(message) {
    ...
    fromJSON(object) {
        return {
            ...
            features: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.features)
                ? object.features.map((e) => globalThis.String(e))
                : [],
        };
    },
    toJSON(message) {
