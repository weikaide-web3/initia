...
exports.ClassTrace = {
    ...
    fromJSON(object) {
        return {
            ...
            baseClassId: isSet(object.baseClassId) ? globalThis.String(object.baseClassId) : "",
        };
    },
    toJSON(message) {
        const obj = {};
    ...
    create(base) {
        return exports.ClassTrace.fromPartial(base !== null && base !== void 0 ? base : {});
    },
    fromPartial(object) {
        var _a, _b;
        const message = createBaseClassTrace();
        message.path = (_a = object.path) !== null && _a !== void 0 ? _a : "";
        message.baseClassId = (_b = object.baseClassId) !== null && _b !== void 0 ? _b : "";
        return message;
    },
};
