...
exports.Fee = {
    ...
    fromJSON(object) {
        return {
            recvFee: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.recvFee)
                ? object.recvFee.map((e) => coin_1.Coin.fromJSON(e))
                : [],
...
exports.PacketFee = {
    ...
    fromJSON(object) {
        return {
            ...
            relayers: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.relayers)
                ? object.relayers.map((e) => globalThis.String(e))
                : [],
        };
    },
    toJSON(message) {
