...
exports.StakeAuthorization = {
    ...
    fromJSON(object) {
        return {
            maxTokens: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.maxTokens)
    ...
    toJSON(message) {
        var _a;
        const obj = {};
        if ((_a = message.maxTokens) === null || _a === void 0 ? void 0 : _a.length) {
    ...
    fromPartial(object) {
        var _a, _b;
        const message = createBaseStakeAuthorization();
        message.maxTokens = ((_a = object.maxTokens) === null || _a === void 0 ? void 0 : _a.map((e) => coin_1.Coin.fromPartial(e))) || [];
        message.allowList =
        ...
        message.denyList =
            object.denyList !== undefined && object.denyList !== null
                ...
                : undefined;
        message.authorizationType = (_b = object.authorizationType) !== null && _b !== void 0 ? _b : 0;
        return message;
    },
};
...
exports.StakeAuthorization_Validators = {
    ...
    fromJSON(object) {
        return {
            address: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.address)
                ? object.address.map((e) => globalThis.String(e))
                : [],
        };
    },
    toJSON(message) {
