...
exports.Validator = {
    ...
    fromJSON(object) {
        return {
            ...
            delegatorShares: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.delegatorShares)
            ...
            votingPowers: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.votingPowers)
                ? object.votingPowers.map((e) => coin_1.Coin.fromJSON(e))
                : [],
            votingPower: isSet(object.votingPower) ? globalThis.String(object.votingPower) : "",
    ...
    toJSON(message) {
        ...
        if ((_b = message.delegatorShares) === null || _b === void 0 ? void 0 : _b.length) {
        ...
        if ((_c = message.votingPowers) === null || _c === void 0 ? void 0 : _c.length) {
    ...
    fromPartial(object) {
        ...
        message.delegatorShares = ((_e = object.delegatorShares) === null || _e === void 0 ? void 0 : _e.map((e) => coin_1.DecCoin.fromPartial(e))) || [];
        message.description =
        ...
        message.commission =
            object.commission !== undefined && object.commission !== null
                ...
                : undefined;
        message.votingPowers = ((_g = object.votingPowers) === null || _g === void 0 ? void 0 : _g.map((e) => coin_1.Coin.fromPartial(e))) || [];
        message.votingPower = (_h = object.votingPower) !== null && _h !== void 0 ? _h : "";
...
exports.Delegation = {
    ...
    fromJSON(object) {
        return {
            delegatorAddress: isSet(object.delegatorAddress) ? globalThis.String(object.delegatorAddress) : "",
            validatorAddress: isSet(object.validatorAddress) ? globalThis.String(object.validatorAddress) : "",
            shares: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.shares)
    ...
    toJSON(message) {
        ...
        if ((_a = message.shares) === null || _a === void 0 ? void 0 : _a.length) {
...
exports.UnbondingDelegationEntry = {
    ...
    fromJSON(object) {
        return {
            ...
            initialBalance: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.initialBalance)
                ? object.initialBalance.map((e) => coin_1.Coin.fromJSON(e))
                : [],
            balance: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.balance)
    ...
    toJSON(message) {
        ...
        if ((_a = message.initialBalance) === null || _a === void 0 ? void 0 : _a.length) {
            obj.initialBalance = message.initialBalance.map((e) => coin_1.Coin.toJSON(e));
        }
        if ((_b = message.balance) === null || _b === void 0 ? void 0 : _b.length) {
    ...
    fromPartial(object) {
        ...
        message.initialBalance = ((_b = object.initialBalance) === null || _b === void 0 ? void 0 : _b.map((e) => coin_1.Coin.fromPartial(e))) || [];
...
exports.RedelegationEntry = {
    ...
    fromJSON(object) {
        return {
            ...
            initialBalance: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.initialBalance)
                ? object.initialBalance.map((e) => coin_1.Coin.fromJSON(e))
                : [],
            sharesDst: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.sharesDst)
    ...
    toJSON(message) {
        ...
        if ((_b = message.sharesDst) === null || _b === void 0 ? void 0 : _b.length) {
    ...
    fromPartial(object) {
        ...
        message.completionTime = (_a = object.completionTime) !== null && _a !== void 0 ? _a : undefined;
        message.initialBalance = ((_b = object.initialBalance) === null || _b === void 0 ? void 0 : _b.map((e) => coin_1.Coin.fromPartial(e))) || [];
        message.sharesDst = ((_c = object.sharesDst) === null || _c === void 0 ? void 0 : _c.map((e) => coin_1.DecCoin.fromPartial(e))) || [];
        message.unbondingId =
            object.unbondingId !== undefined && object.unbondingId !== null
                ? long_1.default.fromValue(object.unbondingId)
                : long_1.default.UZERO;
...
function createBaseParams() {
    return {
        ...
        historicalEntries: 0,
        bondDenoms: [],
        minVotingPower: long_1.default.UZERO,
        minCommissionRate: "",
    };
}
exports.Params = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        if (!message.minVotingPower.isZero()) {
    ...
    fromJSON(object) {
        return {
            ...
            bondDenoms: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.bondDenoms)
                ? object.bondDenoms.map((e) => globalThis.String(e))
                : [],
            minVotingPower: isSet(object.minVotingPower) ? long_1.default.fromValue(object.minVotingPower) : long_1.default.UZERO,
    ...
    toJSON(message) {
        ...
        if ((_a = message.bondDenoms) === null || _a === void 0 ? void 0 : _a.length) {
            obj.bondDenoms = message.bondDenoms;
        }
        if (!message.minVotingPower.isZero()) {
            obj.minVotingPower = (message.minVotingPower || long_1.default.UZERO).toString();
        }
        if (message.minCommissionRate !== "") {
    ...
    fromPartial(object) {
        ...
        message.minVotingPower =
            object.minVotingPower !== undefined && object.minVotingPower !== null
                ? long_1.default.fromValue(object.minVotingPower)
                : long_1.default.UZERO;
...
exports.DelegationResponse = {
    ...
    toJSON(message) {
        ...
        if ((_a = message.balance) === null || _a === void 0 ? void 0 : _a.length) {
            obj.balance = message.balance.map((e) => coin_1.Coin.toJSON(e));
        }
        return obj;
    },
...
exports.Pool = {
    ...
    fromJSON(object) {
        return {
            notBondedTokens: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.notBondedTokens)
                ? object.notBondedTokens.map((e) => coin_1.Coin.fromJSON(e))
                : [],
            bondedTokens: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.bondedTokens)
                ? object.bondedTokens.map((e) => coin_1.Coin.fromJSON(e))
                : [],
            votingPowerWeights: globalThis.Array.isArray(object === null || object === void 0 ? void 0 : object.votingPowerWeights)
    ...
    toJSON(message) {
        var _a, _b, _c;
        const obj = {};
        if ((_a = message.notBondedTokens) === null || _a === void 0 ? void 0 : _a.length) {
            obj.notBondedTokens = message.notBondedTokens.map((e) => coin_1.Coin.toJSON(e));
        }
        if ((_b = message.bondedTokens) === null || _b === void 0 ? void 0 : _b.length) {
            obj.bondedTokens = message.bondedTokens.map((e) => coin_1.Coin.toJSON(e));
        }
        if ((_c = message.votingPowerWeights) === null || _c === void 0 ? void 0 : _c.length) {
    ...
    fromPartial(object) {
        var _a, _b, _c;
        const message = createBasePool();
        message.notBondedTokens = ((_a = object.notBondedTokens) === null || _a === void 0 ? void 0 : _a.map((e) => coin_1.Coin.fromPartial(e))) || [];
        message.bondedTokens = ((_b = object.bondedTokens) === null || _b === void 0 ? void 0 : _b.map((e) => coin_1.Coin.fromPartial(e))) || [];
        message.votingPowerWeights = ((_c = object.votingPowerWeights) === null || _c === void 0 ? void 0 : _c.map((e) => coin_1.DecCoin.fromPartial(e))) || [];
        return message;
    },
};
