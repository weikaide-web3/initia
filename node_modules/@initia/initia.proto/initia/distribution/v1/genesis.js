...
exports.ValidatorOutstandingRewardsRecord = {
    ...
    fromPartial(object) {
        ...
        message.outstandingRewards = ((_b = object.outstandingRewards) === null || _b === void 0 ? void 0 : _b.map((e) => distribution_2.DecPool.fromPartial(e))) || [];
        return message;
    },
};
...
exports.GenesisState = {
    ...
    fromPartial(object) {
        ...
        message.delegatorWithdrawInfos =
            ((_a = object.delegatorWithdrawInfos) === null || _a === void 0 ? void 0 : _a.map((e) => genesis_1.DelegatorWithdrawInfo.fromPartial(e))) || [];
