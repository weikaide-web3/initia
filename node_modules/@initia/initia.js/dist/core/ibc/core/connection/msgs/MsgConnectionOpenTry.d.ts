...
export declare class MsgConnectionOpenTry extends JSONSerializable<any, MsgConnectionOpenTry.Data, MsgConnectionOpenTry.Proto> {
     ...
     */
    constructor(client_id: string, client_state: any, counterparty: ConnectionCounterparty | undefined, delay_period: number, counterparty_versions: IbcVersion[], proof_height: Height | undefined, proof_init: string, proof_client: string, proof_consensus: string, consensus_height: Height | undefined, signer: AccAddress);
