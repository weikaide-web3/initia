...
export type IbcClientMsg = MsgCreateClient | MsgUpdateClient | MsgUpgradeClient | MsgSubmitMisbehaviour | MsgRecoverClient | MsgIBCSoftwareUpgrade | MsgUpdateIbcClientParams;
export declare namespace IbcClientMsg {
    type Data = MsgCreateClient.Data | MsgUpdateClient.Data | MsgUpgradeClient.Data | MsgSubmitMisbehaviour.Data | MsgRecoverClient.Data | MsgIBCSoftwareUpgrade.Data | MsgUpdateIbcClientParams.Data;
    type Proto = MsgCreateClient.Proto | MsgUpdateClient.Proto | MsgUpgradeClient.Proto | MsgSubmitMisbehaviour.Proto | MsgRecoverClient.Proto | MsgIBCSoftwareUpgrade.Proto | MsgUpdateIbcClientParams.Proto;
}
