...
class WebSocketClient extends events_1.EventEmitter {
     ...
     */
    constructor(URL, reconnectCount = 0, reconnectInterval = 1000) {
        super();
        this.URL = URL;
    ...
    subscribe(event, query, callback) {
        this.queryParams = makeQueryParams(Object.assign({ 'tm.event': event }, query));
        this.callback = callback;
    }
    subscribeTx(query, callback) {
        const newCallback = d => {
            d.value.TxResult.txhash = (0, util_1.hashToHex)(d.value.TxResult.tx);
            return callback(d);
        };
