...
exports.LocalInitia = void 0;
const LCDClient_1 = require("./lcd/LCDClient");
const MnemonicKey_1 = require("../key/MnemonicKey");
...
class LocalInitia extends LCDClient_1.LCDClient {
    constructor() {
        super('https://stone-rest.initia.tech', { chainId: 'localinitia' });
        this.wallets = {
            validator: this.wallet(new MnemonicKey_1.MnemonicKey({ mnemonic: LOCALINITIA_MNEMONICS.validator })),
            test1: this.wallet(new MnemonicKey_1.MnemonicKey({ mnemonic: LOCALINITIA_MNEMONICS.test1 })),
            test2: this.wallet(new MnemonicKey_1.MnemonicKey({ mnemonic: LOCALINITIA_MNEMONICS.test2 })),
            test3: this.wallet(new MnemonicKey_1.MnemonicKey({ mnemonic: LOCALINITIA_MNEMONICS.test3 })),
            test4: this.wallet(new MnemonicKey_1.MnemonicKey({ mnemonic: LOCALINITIA_MNEMONICS.test4 })),
            test5: this.wallet(new MnemonicKey_1.MnemonicKey({ mnemonic: LOCALINITIA_MNEMONICS.test5 })),
            test6: this.wallet(new MnemonicKey_1.MnemonicKey({ mnemonic: LOCALINITIA_MNEMONICS.test6 })),
            test7: this.wallet(new MnemonicKey_1.MnemonicKey({ mnemonic: LOCALINITIA_MNEMONICS.test7 })),
            test8: this.wallet(new MnemonicKey_1.MnemonicKey({ mnemonic: LOCALINITIA_MNEMONICS.test8 })),
            test9: this.wallet(new MnemonicKey_1.MnemonicKey({ mnemonic: LOCALINITIA_MNEMONICS.test9 })),
            test10: this.wallet(new MnemonicKey_1.MnemonicKey({ mnemonic: LOCALINITIA_MNEMONICS.test10 })),
        };
    }
}
exports.LocalInitia = LocalInitia;
//# sourceMappingURL=LocalInitia.js.map